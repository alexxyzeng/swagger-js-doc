 ...
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/workorder-approval/searchUsingGET_6
 * @summary 查询工单审批列表
 * @description 
 * @param {object} params
...
*/
export function searchUsingGET_6(params) {
  return API.get(`/workorder-approval/search`, { params: { ...params.query })
}
