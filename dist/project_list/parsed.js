...
/**
 * @typedef {object} listUsingGET_2Response
...
/**
 * @tags base-project
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/base-project/listUsingGET_2
 ...
 * @return {Promise<listUsingGET_2Response>}
*/
export function listUsingGET_2(params) {
  return API.get(`/project/list`, { params: { ...params.query })
}
