...
/**
 * @typedef {object} findUsingGET_20Response
...
/**
 * @typedef {object} createUsingPOST_10Response
 * @property {number} code 业务响应状态
 * @property {data} data 
 * @property {string} message 消息
 * @property {string} traceId 用于链路追踪的ID
...
/**
 * @tags facility
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/facility/findUsingGET_20
 * @summary 设备台帐列表
 * @description 
 * @param {object} params
 ...
 * @return {Promise<findUsingGET_20Response>}
*/
...
/**
 * @tags facility
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/facility/createUsingPOST_10
 * @summary 新增设备
 * @description 
 * @param {object} params
  * @param {createUsingPOST_10Body} params.body - 请求体 undefined
 * @return {Promise<createUsingPOST_10Response>}
*/
