...
/**
 * @typedef {object} completeUsingPUTResponse
 ...
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/service-center-demand/completeUsingPUT
 * @summary 需求完成
 * @description 
 * @param {object} params
 * @param {number} params.id - path
 * @return {Promise<completeUsingPUTResponse>}
*/
