/**
 * @typedef {object} countUsingGETResponse
...
/**
 * @tags base-message
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/base-message/countUsingGET
 * @summary 消息数
 * @description 
 * @param {object} params
 ...
 * @return {Promise<countUsingGETResponse>}
*/
export function countUsingGET(params) {
  return API.get(`/message/send/count`, { params: { ...params.query })
}
