...
/**
 * @typedef {object} findByIdUsingGET_32Response
...
/**
 * @typedef {object} deleteUsingDELETE_32Response
 * @property {number} code 业务响应状态
 * @property {string} message 消息
 * @property {string} traceId 用于链路追踪的ID
 *
...
/**
 * @tags inventory
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/inventory/findByIdUsingGET_32
 * @summary 库存-详情
 * @description 
 * @param {object} params
 * @param {number} params.id - path
 * @return {Promise<findByIdUsingGET_32Response>}
*/
...
/**
 * @tags inventory
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/inventory/deleteUsingDELETE_32
 * @summary 删除库存
 * @description 
 * @param {object} params
 * @param {number} params.id - path
 * @return {Promise<deleteUsingDELETE_32Response>}
*/
