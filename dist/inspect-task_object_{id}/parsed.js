...
/**
 * @typedef {object} findByIdUsingGET_26Response
...
/**
 * @typedef {object} updateUsingPUT_34Response
 * @property {number} code 业务响应状态
 * @property {data} data 
 * @property {string} message 消息
 * @property {string} traceId 用于链路追踪的ID
...
/**
 * @tags inspect-task
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/inspect-task/findByIdUsingGET_26
 * @summary 巡检任务-对象-详情
 * @description 
 * @param {object} params
 * @param {number} params.id - path
 * @return {Promise<findByIdUsingGET_26Response>}
*/
...
/**
 * @tags inspect-task
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/inspect-task/updateUsingPUT_34
 * @summary 修改巡检任务-对象-部分
 * @description 
 * @param {object} params
 * @param {number} params.id - path
 * @param {updateUsingPUT_34Body} params.body - 请求体 undefined
 * @return {Promise<updateUsingPUT_34Response>}
*/
