...
/**
 * @typedef {object} historyUsingGETResponse
...
/**
 * @tags inspect-task
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/inspect-task/historyUsingGET
 * @summary 巡检任务-历史列表
 * @description 
 * @param {object} params
 ...
 * @return {Promise<historyUsingGETResponse>}
*/
export function historyUsingGET(params) {
  return API.get(`/inspect-task/history`, { params: { ...params.query })
}
