/**
 * @typedef {object} patchUsingPUT_1Response
...
/**
 * @tags inspect-task
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/inspect-task/patchUsingPUT_1
 * @summary 巡检任务-工作对象-补检(app)
 * @description 
 * @param {object} params
 * @param {number} params.id - path
 * @param {patchUsingPUT_1Body} params.body - 请求体 undefined
 * @return {Promise<patchUsingPUT_1Response>}
*/
export function patchUsingPUT_1(params) {
  return API.put(`/inspect-task/object/${params.id}/patch`, { ...params.body })
}
