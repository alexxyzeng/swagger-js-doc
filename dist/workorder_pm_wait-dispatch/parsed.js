...
/**
 * @tags workorder-pm
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/workorder-pm/waitDispatchUsingGET_1
 * @summary 待派工列表
 * @description 
 * @param {object} params
...
*/
export function waitDispatchUsingGET_1(params) {
  return API.get(`/workorder/pm/wait-dispatch`, { params: { ...params.query })
}
