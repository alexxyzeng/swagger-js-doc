...
/**
 * @typedef {object} findByCodeUsingGETResponse
 ...
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/base-org-department/findByCodeUsingGET
 * @summary 查找指定编码的部门
 * @description 
 * @param {object} params
 * @param {string} params.code - path
 * @return {Promise<findByCodeUsingGETResponse>}
*/
export function findByCodeUsingGET(params) {
  return API.get(`/department/byCode/${params.code}`, {})
}
