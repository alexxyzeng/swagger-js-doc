...
/**
 * @typedef {object} findLevelOfPhotographUsingGET_2Response
 ...
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/service-center-demand-type/findLevelOfPhotographUsingGET_2
 * @summary 需求类型-随手拍-层级查询
 * @description 
 * @param {object} params
 * @param {number} params.parentId - path
 * @return {Promise<findLevelOfPhotographUsingGET_2Response>}
*/
