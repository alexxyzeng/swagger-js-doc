 ...
 * @property {string} isAdmin 是否系统管理员 是否枚举{否=No-0, 是=Yes-1}
 * @property {string} isSuperAdmin 是否超级管理员 是否枚举{否=No-0, 是=Yes-1}
 * @property {string} isThirdPartAccount 是否一事通账号 是否枚举{否=No-0, 是=Yes-1}
...
/**
 * @typedef {object} findBySelfUsingGETResponse
...
/**
 * @typedef {object} updateBySelfUsingPUTResponse
 * @property {number} code 业务响应状态
 * @property {data} data [object Object]
 * @property {string} message 消息
 * @property {string} traceId 用于链路追踪的ID
...
/**
 * @tags base-employee
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/base-employee/findBySelfUsingGET
 * @summary 查询用户个人信息
 * @description 
 * @param {object} params
 
 * @return {Promise<findBySelfUsingGETResponse>}
*/
export function findBySelfUsingGET() {
  return API.get(`/employee/self`, {})
}

/**
 * @tags base-employee
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/base-employee/updateBySelfUsingPUT
 * @summary 修改用户个人信息
 * @description 
 * @param {object} params
  * @param {updateBySelfUsingPUTBody} params.body - 请求体 [object Object]
 * @return {Promise<updateBySelfUsingPUTResponse>}
*/
