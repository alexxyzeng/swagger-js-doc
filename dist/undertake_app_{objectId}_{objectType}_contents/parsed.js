...
/**
 * @typedef {object} findByObjectIdUsingGETResponse
...
/**
 * @tags undertake-app
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/undertake-app/findByObjectIdUsingGET
 * @summary 查验内容列表
 * @description 
 * @param {object} params
 * @param {number} params.objectId - path
* @param {string} params.objectType - path
 * @return {Promise<findByObjectIdUsingGETResponse>}
*/
