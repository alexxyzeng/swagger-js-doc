...
/**
 * @typedef {object} detailUsingGET_1Response
...
/**
 * @typedef {object} patchUsingPUT_2Response
 * @property {number} code 业务响应状态
 * @property {data} data 
 * @property {string} message 消息
 * @property {string} traceId 用于链路追踪的ID
...
/**
 * @typedef {object} deleteUsingDELETE_41Response
 * @property {number} code 业务响应状态
 * @property {string} message 消息
 * @property {string} traceId 用于链路追踪的ID
 *
...
/**
 * @tags base-project
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/base-project/detailUsingGET_1
 * @summary 项目详情
 * @description 
 * @param {object} params
 * @param {number} params.id - path
 * @return {Promise<detailUsingGET_1Response>}
*/
...
/**
 * @tags base-project
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/base-project/patchUsingPUT_2
 * @summary 修改项目信息
 * @description 
 * @param {object} params
 * @param {number} params.id - path
 * @param {patchUsingPUT_2Body} params.body - 请求体 undefined
 * @return {Promise<patchUsingPUT_2Response>}
*/
...
/**
 * @tags base-project
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/base-project/deleteUsingDELETE_41
 * @summary 删除项目
 * @description 
 * @param {object} params
 * @param {number} params.id - path
 * @return {Promise<deleteUsingDELETE_41Response>}
*/
