...
/**
 * @typedef {object} updateBaseInfoUsingPUTResponse
...
/**
 * @tags base-employee
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/base-employee/updateBaseInfoUsingPUT
 * @summary 修改用户基本信息
 * @description 
 * @param {object} params
 * @param {number} params.userId - path
 * @param {updateBaseInfoUsingPUTBody} params.body - 请求体 [object Object]
 * @return {Promise<updateBaseInfoUsingPUTResponse>}
*/
