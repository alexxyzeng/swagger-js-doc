 ...
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/workorder-evaluate/customerEvaluateUsingPOST
 * @summary 客户评价
 * @description 
 * @param {object} params
 * @param {number} params.workorderId - path
 * @param {customerEvaluateUsingPOSTBody} params.body - 请求体 undefined
 * @return {Promise}<TO BE IMPLEMENTED>
*/
export function customerEvaluateUsingPOST(params) {
  return API.post(`/workorder-evaluate/customer/${params.workorderId}`, { ...params.body })
}
