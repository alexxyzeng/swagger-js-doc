...
/**
 * @typedef {object} updateNameInfoUsingPUTResponse
...
/**
 * @tags base-employee
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/base-employee/updateNameInfoUsingPUT
 * @summary 修改用户姓名信息
 * @description 
 * @param {object} params
 * @param {number} params.userId - path
 * @param {updateNameInfoUsingPUTBody} params.body - 请求体 undefined
 * @return {Promise<updateNameInfoUsingPUTResponse>}
*/
