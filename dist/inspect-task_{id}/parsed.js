 ...
 * @property {string} facilityStatus 设备状态 {在用=Run-1, 停用=Stop-2}
 * @property {string} facilityType 系统分类
 * @property {number} id 巡检点位-工作任务-设备唯一id
 ...
 * @property {string} isWorkorder 是否报修 是否枚举{否=No-0, 是=Yes-1}
 ...
 * @property {number} operator 操作人
 * @property {string} operatorUser 操作人
 * @property {number} patchBy 补检人
 * @property {string} patchByUser 补检人
 * @property {string} patchEndTime 补检结束时间
 * @property {string} patchStartTime 补检开始时间
 ...
 * @property {string} personnel 实际巡检人员
 ...
 * @property {string} state 任务状态 1-未完成 2-已完成 {未完成=Unfinished-1, 已完成=Complete-2}
 * @property {string} status 查询状态 1-未开始 2-进行中 3-按时完成 4-延期完成 5-未巡检 {未开始=Unstart-1, 进行中=Process-2, 按时完成=Complate-3, 延期完成=DelayComplate-4, 未巡检=NoPolling-5}
 * @property {string} submit 提交 1-未提交 2-部分提交 3-全部提交 {未提交=Nd-1, 部分提交=Part-2, 全部提交=All-3}
 * @property {string} workTeam 计划巡检人员
 * @property {number} workTeamId 巡检工作组
 * @property {[workordersItem]} workorders
 *
*/

/**
 * @typedef {object} findByIdUsingGET_24Response
...
/**
 * @typedef {object} updateUsingPUT_31Response
 * @property {number} code 业务响应状态
 * @property {data} data 
 * @property {string} message 消息
 * @property {string} traceId 用于链路追踪的ID
...
/**
 * @tags inspect-task
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/inspect-task/findByIdUsingGET_24
 * @summary 巡检任务-详情
 * @description 
 * @param {object} params
 * @param {number} params.id - path
 * @return {Promise<findByIdUsingGET_24Response>}
*/
...
/**
 * @tags inspect-task
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/inspect-task/updateUsingPUT_31
 * @summary 修改巡检任务-部分
 * @description 
 * @param {object} params
 * @param {number} params.id - path
 * @param {updateUsingPUT_31Body} params.body - 请求体 undefined
 * @return {Promise<updateUsingPUT_31Response>}
*/
