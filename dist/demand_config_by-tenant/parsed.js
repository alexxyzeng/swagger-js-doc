...
/**
 * @typedef {object} findByTenantIdUsingGETResponse
...
/**
 * @typedef {object} updateByTenantUsingPUTResponse
 * @property {number} code 业务响应状态
 * @property {data} data 
 * @property {string} message 消息
 * @property {string} traceId 用于链路追踪的ID
 ...
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/service-center-demand-config/findByTenantIdUsingGET
 * @summary 需求配置-根据租户
 * @description 
 * @param {object} params
 
 * @return {Promise<findByTenantIdUsingGETResponse>}
*/
export function findByTenantIdUsingGET() {
  return API.get(`/demand/config/by-tenant`, {})
}

/**
 * @tags service-center-demand-config
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/service-center-demand-config/updateByTenantUsingPUT
 * @summary 修改需求配置-根据租户
 * @description 
 * @param {object} params
  * @param {updateByTenantUsingPUTBody} params.body - 请求体 undefined
 * @return {Promise<updateByTenantUsingPUTResponse>}
*/
