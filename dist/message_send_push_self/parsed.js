...
/**
 * @typedef {object} findPushOfSelfUsingGETResponse
...
/**
 * @tags base-message
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/base-message/findPushOfSelfUsingGET
 * @summary 个人移动推送信息列表
 * @description 
 * @param {object} params
 ...
 * @return {Promise<findPushOfSelfUsingGETResponse>}
*/
export function findPushOfSelfUsingGET(params) {
  return API.get(`/message/send/push/self`, { params: { ...params.query })
}
