...
/**
 * @tags workorder-pm
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/workorder-pm/waitArchiveUsingGET_1
 * @summary 待存档列表
 * @description 
 * @param {object} params
...
*/
export function waitArchiveUsingGET_1(params) {
  return API.get(`/workorder/pm/wait-archive`, { params: { ...params.query })
}
