...
/**
 * @typedef {object} updatePhoneInfoUsingPUTResponse
...
/**
 * @tags base-employee
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/base-employee/updatePhoneInfoUsingPUT
 * @summary 修改用户手机号信息
 * @description 
 * @param {object} params
 * @param {number} params.userId - path
 * @param {updatePhoneInfoUsingPUTBody} params.body - 请求体 undefined
 * @return {Promise<updatePhoneInfoUsingPUTResponse>}
*/
