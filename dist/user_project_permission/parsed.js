...
/**
 * @typedef {object} findUserProjectPermissionUsingGETResponse
 ...
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/app-index/findUserProjectPermissionUsingGET
 * @summary 获取当前登录用户项目权限
 * @description 
 * @param {object} params
 
 * @return {Promise<findUserProjectPermissionUsingGETResponse>}
*/
export function findUserProjectPermissionUsingGET() {
