...
/**
 * @typedef {object} updateEmNoInfoUsingPUTResponse
...
/**
 * @tags base-employee
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/base-employee/updateEmNoInfoUsingPUT
 * @summary 修改用户工号信息
 * @description 
 * @param {object} params
 * @param {number} params.userId - path
 * @param {updateEmNoInfoUsingPUTBody} params.body - 请求体 undefined
 * @return {Promise<updateEmNoInfoUsingPUTResponse>}
*/
