...
/**
 * @tags workorder-pm
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/workorder-pm/getPmStatusConfigUsingGET
 * @summary 查询工单状态字典项
 * @description 
 * @param {object} params
...
*/
export function getPmStatusConfigUsingGET(params) {
  return API.get(`/workorder/pm/config/status`, {})
}
