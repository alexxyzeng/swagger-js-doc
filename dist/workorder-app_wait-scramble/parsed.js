...
/**
 * @typedef {object} waitScrambleUsingGETResponse
...
/**
 * @tags workorder-app
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/workorder-app/waitScrambleUsingGET
 * @summary 待抢单列表
 * @description 
 * @param {object} params
 ...
 * @return {Promise<waitScrambleUsingGETResponse>}
*/
export function waitScrambleUsingGET(params) {
  return API.get(`/workorder-app/wait-scramble`, { params: { ...params.query })
}
