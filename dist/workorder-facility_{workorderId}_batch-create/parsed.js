 ...
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/workorder-facility/batchCreateUsingPOST_1
 * @summary 创建工单对应的设备
 * @description 
 * @param {object} params
 * @param {number} params.workorderId - path
 * @param {batchCreateUsingPOST_1Body} params.body - 请求体 undefined
