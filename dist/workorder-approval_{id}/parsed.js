...
/**
 * @typedef {object} currentAndNextProcessItem
...
/**
 * @typedef {object} executorListItem
...
/**
 * @typedef {object} dispatchDto
 * @property {string} content 派发工作内容
 * @property {string} createTime 创建时间
 * @property {string} dispatchedTime 派工时间
 * @property {number} employeeId 派工员工id
 * @property {[executorListItem]} executorList
 * @property {number} id 由程序分配的唯一ID
 * @property {string} modifyTime 最后的修改时间
 * @property {number} projectId 项目ID
 * @property {number} woWorkorderId 工单id
 ...
 * @property {number} totalCost 收费总费用 单位：元
 * @property {number} totalToolCost 工具总费用 单位：元
...
/**
 * @typedef {object} workorderDetailRspDto
 * @property {string} actualEndTime 实际结束时间
 * @property {string} actualStartTime 实际开始时间
 * @property {string} appointmentEndTime 预约结束时间(服务中心)/计划结束时间(预防性维护)
 * @property {string} appointmentStartTime 预约开始时间(服务中心)/计划开始时间(预防性维护)
 ...
 * @property {string} woDescription 工单描述
 * @property {number} woWorkorderId 工单id
 * @property {workorder} workorder [object Object]
 * @property {workorderDetailRspDto} workorderDetailRspDto [object Object]
 *
*/

/**
 * @typedef {object} searchByIdUsingGETResponse
 ...
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/workorder-approval/searchByIdUsingGET
 * @summary 查询工单审批详情
 * @description 
 * @param {object} params
 * @param {number} params.id - path
 * @return {Promise<searchByIdUsingGETResponse>}
*/
export function searchByIdUsingGET(params) {
  return API.get(`/workorder-approval/${params.id}`, {})
}
