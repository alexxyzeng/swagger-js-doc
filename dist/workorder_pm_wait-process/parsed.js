...
/**
 * @tags workorder-pm
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/workorder-pm/waitProcessUsingGET_1
 * @summary 待处理列表
 * @description 
 * @param {object} params
...
*/
export function waitProcessUsingGET_1(params) {
  return API.get(`/workorder/pm/wait-process`, { params: { ...params.query })
}
