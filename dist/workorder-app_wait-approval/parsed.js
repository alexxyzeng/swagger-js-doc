...
/**
 * @typedef {object} waitApprovalUsingGETResponse
...
/**
 * @tags workorder-app
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/workorder-app/waitApprovalUsingGET
 * @summary 待审批列表
 * @description 
 * @param {object} params
 ...
 * @return {Promise<waitApprovalUsingGETResponse>}
*/
export function waitApprovalUsingGET(params) {
  return API.get(`/workorder-app/wait-approval`, { params: { ...params.query })
}
