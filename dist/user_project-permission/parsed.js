...
/**
 * @typedef {object} data
 * @property {boolean} canAccessProjectHome 是否有项目主页权限
 * @property {[projectsItem]} projects
 *
*/

/**
 * @typedef {object} userProjectPermissionUsingGETResponse
 ...
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/app-index/userProjectPermissionUsingGET
 * @summary 获取当前登录用户项目权限
 * @description 
 * @param {object} params
 
 * @return {Promise<userProjectPermissionUsingGETResponse>}
*/
export function userProjectPermissionUsingGET() {
