...
/**
 * @typedef {object} transferUsingPUTResponse
...
/**
 * @tags workorder-app
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/workorder-app/transferUsingPUT
 * @summary 转单
 * @description 
 * @param {object} params
 * @param {number} params.id - path
 * @param {transferUsingPUTBody} params.body - 请求体 [object Object]
 * @return {Promise<transferUsingPUTResponse>}
*/
