 ...
 * @property {number} demandTypeRefId 需求类型同步ID
 ...
 * @property {string} isSyncDemandType 当前项目是否已同步指定需求类型 是否枚举{否=No-0, 是=Yes-1}
...
/**
 * @typedef {object} searchDemandTypeStatusUsingGETResponse
...
/**
 * @tags base-project
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/base-project/searchDemandTypeStatusUsingGET
 * @summary 查询项目同步的需求类型的状态
 * @description 
 * @param {object} params
 * @param {number} params.demandTypeId - path
 * @return {Promise<searchDemandTypeStatusUsingGETResponse>}
*/
