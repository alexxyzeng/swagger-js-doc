 ...
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/workorder-service-type-ref/findSyncStatusUsingGET
 * @summary 查询服务类型同步状态
 * @description 
 * @param {object} params
...
*/
export function findSyncStatusUsingGET(params) {
  return API.get(`/workorder/service-type-ref/sync-status/search`, {})
}
