...
/**
 * @typedef {object} findUsingGET_34Response
...
/**
 * @tags inspect-task
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/inspect-task/findUsingGET_34
 * @summary 巡检任务-查询列表
 * @description 
 * @param {object} params
 ...
 * @return {Promise<findUsingGET_34Response>}
*/
export function findUsingGET_34(params) {
  return API.get(`/inspect-task`, { params: { ...params.query })
}
