...
/**
 * @typedef {object} syncDemandTypeUsingPUTResponse
 ...
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/service-center-demand-type/syncDemandTypeUsingPUT
 * @summary 同步需求类型
 * @description 
 * @param {object} params
  * @param {syncDemandTypeUsingPUTBody} params.body - 请求体 undefined
 * @return {Promise<syncDemandTypeUsingPUTResponse>}
*/
