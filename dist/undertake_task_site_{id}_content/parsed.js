 ...
 * @property {string} wholeSpaceName 位置
 *
*/

/**
 * @typedef {object} findContentByIdUsingGET_1Response
 ...
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/undertake-task-site/findContentByIdUsingGET_1
 * @summary 承接查验-任务-对象(位置)-详情
 * @description 
 * @param {object} params
 * @param {number} params.id - path
 * @return {Promise<findContentByIdUsingGET_1Response>}
*/
