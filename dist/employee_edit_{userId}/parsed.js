...
/**
 * @typedef {object} findEditDetailUsingGETResponse
...
/**
 * @tags base-employee
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/base-employee/findEditDetailUsingGET
 * @summary 用户编辑详情
 * @description 
 * @param {object} params
 * @param {number} params.userId - path
 * @return {Promise<findEditDetailUsingGETResponse>}
*/
export function findEditDetailUsingGET(params) {
  return API.get(`/employee/edit/${params.userId}`, {})
}
