/**
 * @typedef {object} checkResultsItem
 * @property {string} type 工单创建数据校验类型 {部门=Department-1, 服务类型=ServiceType-2, 空间位置=WholeSpace-3, 大楼=Building-4, 楼层=Floor-5, 房间=Space-6, 优先级=Priority-7, 故障设备=Facility-8, 流程设置=Sla-9}
 * @property {number} sort 数据多选时，错误数据对应数组下标，从0开始
 *
*/
...
/**
 * @typedef {object} data
 * @property {[checkResultsItem]} checkResults
 * @property {workorder} workorder [object Object]
 *
*/

/**
 * @typedef {object} createUsingPOST_54Response
...
/**
 * @tags workorder-app
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/workorder-app/createUsingPOST_54
 * @summary 创建工单
 * @description 
 * @param {object} params
  * @param {createUsingPOST_54Body} params.body - 请求体 [object Object]
 * @return {Promise<createUsingPOST_54Response>}
*/
export function createUsingPOST_54(params) {
  return API.post(`/workorder-app`, { ...params.body })
}
