/**
 * @typedef {object} submitUsingPUT_1Response
...
/**
 * @tags inspect-task
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/inspect-task/submitUsingPUT_1
 * @summary 巡检任务-工作任务-提交
 * @description 
 * @param {object} params
 * @param {number} params.id - path
 * @param {submitUsingPUT_1Body} params.body - 请求体 undefined
 * @return {Promise<submitUsingPUT_1Response>}
*/
