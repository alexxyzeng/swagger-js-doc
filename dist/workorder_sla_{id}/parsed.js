...
/**
 * @typedef {object} detailUsingGET_2Response
...
/**
 * @typedef {object} updateUsingPUT_50Response
 * @property {number} code 业务响应状态
 * @property {string} message 消息
 * @property {string} traceId 用于链路追踪的ID
 *
...
/**
 * @typedef {object} deleteUsingDELETE_49Response
 * @property {number} code 业务响应状态
 * @property {string} message 消息
 * @property {string} traceId 用于链路追踪的ID
 *
 ...
 * @return {Promise<detailUsingGET_2Response>}
*/
 ...
 * @return {Promise<updateUsingPUT_50Response>}
*/
 ...
 * @param {object} params
 * @param {number} params.id - path
 * @return {Promise<deleteUsingDELETE_49Response>}
*/
