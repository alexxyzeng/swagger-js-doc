...
/**
 * @typedef {object} findUsingGET_42Response
...
/**
 * @typedef {object} deleteUsingPUT_9Response
 * @property {number} code 业务响应状态
 ...
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/inspect-template/findUsingGET_42
 * @summary 巡检模板-内容-列表
 * @description 
 * @param {object} params
 ...
 * @return {Promise<findUsingGET_42Response>}
*/
...
/**
 * @tags inspect-template
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/inspect-template/deleteUsingPUT_9
 * @summary 批量删除巡检模板-内容
 * @description 
 * @param {object} params
  * @param {[number]} params.body - 请求体 idx
 * @return {Promise<deleteUsingPUT_9Response>}
*/
