...
*/
/**
 * @typedef {object} createUsingPOST_54Body
 * @property {string} description 问题描述
 * @property {[number]} facilities
 * @property {string} isRefFacility 是否关联设备 0-不关联 1-关联 是否枚举{否=No-0, 是=Yes-1}
 * @property {number} orgDepartmentId 部门id
...
*/
/**
 * @typedef {object} transferUsingPUTBody
 * @property {string} description 问题描述
 * @property {[number]} facilities
 * @property {string} isRefFacility 是否关联设备 0-不关联 1-关联 是否枚举{否=No-0, 是=Yes-1}
 * @property {number} orgDepartmentId 部门id
...
*/
/**
 * @typedef {object} customerSignUsingPUTBody
 * @property {[fileTypesItem]} fileTypes
 *
*/
/**
...
*/
/**
 * @typedef {object} approverDtosItem
 * @property {number} employeeId 审批人id
 * @property {string} employeeName 审批人名称
 *
*/
/**
 * @typedef {object} createUsingPOST_55Body
 * @property {[approverDtosItem]} approverDtos
...
*/
/**
 * @typedef {object} customerEvaluateUsingPOSTBody
 * @property {string} feedback 反馈意见
 * @property {[satisfactionsItem]} satisfactions
...
*/
/**
 * @typedef {object} batchCreateUsingPOST_1Body
 * @property {[number]} facFacilityIds
 * @property {string} processDesc 处理方式
 * @property {string} siteDesc 现场描述
 * @property {number} woWorkorderId 工单id, 新增设备时必传
 *
*/
/**
...
*/
/**
 * @typedef {object} updateUsingPUT_63Body
 * @property {string} description 处理方式
 * @property {number} spBuildingId 大楼id
 * @property {number} spFloorId 楼层id
 * @property {number} spSpaceId 房间id
...
*/
/**
 * @typedef {object} updateUsingPUT_50Body
 * @property {string} autoArchive 是否自动存档 0-否 1-是 默认值为0 是否枚举{否=No-0, 是=Yes-1}
 * @property {number} orgDepartmentId 部门id
 * @property {[priorityDtosItem]} priorityDtos
 * @property {number} spBuildingId 大楼ID
...
*/
/**
 * @typedef {object} modifyUsingPUTBody
 * @property {string} description 问题描述
 * @property {number} id 由程序分配的唯一ID
 *
*/
...
*/
/**
 * @typedef {object} batchTransferUsingPUTBodyItem
 
 *
*/
/**
 * @typedef {object} checkUsingPUTBody
 * @property {string} desc 不通过原因
 * @property {string} isPass 验证结果 0-不通过 1-通过 是否枚举{否=No-0, 是=Yes-1}
 * @property {number} woWorkorderId 工单id
 *
*/
/**
 * @typedef {object} continuedUsingPUTBody
 * @property {number} execEmployeeId 工单执行人ID
 * @property {string} execEmployeeName 工单执行人名称
 * @property {number} woExecEmployeeId 工单执行人主键ID
 *
*/
/**
...
*/
/**
 * @typedef {object} dispatchUsingPUTBody
 * @property {string} content 工作内容
 * @property {[executorDtosItem]} executorDtos
 * @property {string} expectEndTime 预计结束时间
 * @property {string} expectStartTime 预计开始时间
 * @property {string} expectWorkTime 预计工作时间
 *
*/
/**
 * @typedef {object} refundUsingPUTBody
 * @property {number} execEmployeeId 工单执行人ID
 * @property {string} execEmployeeName 工单执行人名称
 * @property {number} woExecEmployeeId 工单执行人主键ID
 *
*/
/**
 * @typedef {object} suspendUsingPUTBody
 * @property {string} desc 暂停描述
 * @property {number} execEmployeeId 工单执行人ID
 * @property {string} execEmployeeName 工单执行人名称
 * @property {string} isAllSuspend 是否全部暂停 0-否 1-是 是否枚举{否=No-0, 是=Yes-1}
 * @property {string} isContinue 是否继续 0-否 1-是 是否枚举{否=No-0, 是=Yes-1}
 * @property {number} woExecEmployeeId 工单执行人主键ID
 *
*/
/**
 * @typedef {object} terminationUsingPUTBody
 * @property {string} desc 终止原因
 * @property {string} isTransfer 是否转单 0-否 1-是 是否枚举{否=No-0, 是=Yes-1}
 *
*/
/**
 * @typedef {object} spaceDtosItem
...
*/
/**
 * @typedef {object} transferUsingPUT_1Body
 * @property {string} description 问题描述
 * @property {[number]} facilities
 * @property {string} isRefFacility 是否关联设备 0-不关联 1-关联 是否枚举{否=No-0, 是=Yes-1}
 * @property {number} orgDepartmentId 部门id
...
/**
 * @tags workorder
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/workorder/transferUsingPUT_1
 * @summary 转单
 * @description 
 * @param {object} params
 * @param {number} params.id - path
 * @param {transferUsingPUT_1Body} params.body - 请求体 [object Object]
 * @return {Promise}<TO BE IMPLEMENTED>
*/
export function transferUsingPUT_1(params) {
  return API.put(`/workorder/${params.id}/transfer`, { ...params.body })
}
