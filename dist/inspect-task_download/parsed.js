 ...
 * @property {string} intro 内容介绍
 * @property {string} isMiss 是否漏检 是否枚举{否=No-0, 是=Yes-1}
 * @property {string} isOperator 是否执行人 是否枚举{否=No-0, 是=Yes-1}
 * @property {string} isPatch 是否补检 是否枚举{否=No-0, 是=Yes-1}
 * @property {string} isSubmit 是否提交 是否枚举{否=No-0, 是=Yes-1}
 * @property {string} isWorkorder 是否报修 是否枚举{否=No-0, 是=Yes-1}
 * @property {string} job 工作任务
 ...
 * @property {string} site 点位
 * @property {number} siteId 点位ID
 * @property {string} siteQrcode 点位二维码
 * @property {string} status 状态：1-未完成 2-已完成 {未完成=Unfinished-1, 已完成=Complete-2}
 * @property {synthesize} synthesize 
 * @property {number} synthesizeNum 综合数
 * @property {number} taskId 任务ID
...
/**
 * @typedef {object} downloadInspectDataUsingGETResponse
...
/**
 * @tags inspect-task
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/inspect-task/downloadInspectDataUsingGET
 * @summary 离线下载巡检任务
 * @description 
 * @param {object} params
 * @param {object} params.query - 请求查询参数
* @param {number} params.query.lastUpdatedTimestamp - lastUpdatedTimestamp
 * @return {Promise<downloadInspectDataUsingGETResponse>}
*/
