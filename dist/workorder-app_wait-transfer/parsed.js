...
/**
 * @typedef {object} waitTransferUsingGETResponse
...
/**
 * @tags workorder-app
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/workorder-app/waitTransferUsingGET
 * @summary 待转单列表
 * @description 
 * @param {object} params
 ...
 * @return {Promise<waitTransferUsingGETResponse>}
*/
export function waitTransferUsingGET(params) {
  return API.get(`/workorder-app/wait-transfer`, { params: { ...params.query })
}
