...
/**
 * @typedef {object} findByIdUsingGET_42Response
...
/**
 * @tags systemsetting
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/systemsetting/findByIdUsingGET_42
 * @summary 系统配置-详情
 * @description 
 * @param {object} params
 * @param {number} params.id - path
 * @return {Promise<findByIdUsingGET_42Response>}
*/
export function findByIdUsingGET_42(params) {
  return API.get(`/system/setting/${params.id}`, {})
}
