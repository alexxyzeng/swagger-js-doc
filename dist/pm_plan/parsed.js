...
/**
 * @typedef {object} createUsingPOST_30Response
...
/**
 * @typedef {object} deleteUsingDELETE_34Response
 * @property {number} code 业务响应状态
 * @property {string} message 消息
 * @property {string} traceId 用于链路追踪的ID
 *
...
/**
 * @tags pm-plan
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/pm-plan/createUsingPOST_30
 * @summary 新增计划
 * @description 
 * @param {object} params
  * @param {createUsingPOST_30Body} params.body - 请求体 undefined
 * @return {Promise<createUsingPOST_30Response>}
*/
...
/**
 * @tags pm-plan
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/pm-plan/deleteUsingDELETE_34
 * @summary 删除计划
 * @description 
 * @param {object} params
 ...
 * @return {Promise<deleteUsingDELETE_34Response>}
*/
