...
/**
 * @typedef {object} waitProcessUsingGETResponse
...
/**
 * @tags workorder-app
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/workorder-app/waitProcessUsingGET
 * @summary 待处理列表
 * @description 
 * @param {object} params
 ...
 * @return {Promise<waitProcessUsingGETResponse>}
*/
export function waitProcessUsingGET(params) {
  return API.get(`/workorder-app/wait-process`, { params: { ...params.query })
}
