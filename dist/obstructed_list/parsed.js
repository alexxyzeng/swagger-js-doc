...
/**
 * @typedef {object} listUsingGET_1Response
 ...
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/base-obstructed/listUsingGET_1
 * @summary 查询报障人
 * @description 
 * @param {object} params
 * @param {object} params.query - 请求查询参数
* @param {string} params.query.name - name
 * @return {Promise<listUsingGET_1Response>}
*/
