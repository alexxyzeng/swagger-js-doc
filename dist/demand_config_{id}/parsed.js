...
/**
 * @typedef {object} findByIdUsingGET_3Response
...
/**
 * @typedef {object} updateUsingPUT_5Response
 * @property {number} code 业务响应状态
 * @property {data} data 
 * @property {string} message 消息
 * @property {string} traceId 用于链路追踪的ID
 ...
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/service-center-demand-config/findByIdUsingGET_3
 * @summary 需求配置-详情
 * @description 
 * @param {object} params
 * @param {number} params.id - path
 * @return {Promise<findByIdUsingGET_3Response>}
*/
...
/**
 * @tags service-center-demand-config
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/service-center-demand-config/updateUsingPUT_5
 * @summary 修改需求配置-部分
 * @description 
 * @param {object} params
 * @param {number} params.id - path
 * @param {updateUsingPUT_5Body} params.body - 请求体 undefined
 * @return {Promise<updateUsingPUT_5Response>}
*/
