...
/**
 * @typedef {object} findWaitAcceptUsingGETResponse
...
/**
 * @tags undertake-app
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/undertake-app/findWaitAcceptUsingGET
 * @summary 查验验收
 * @description 
 * @param {object} params
 ...
 * @return {Promise<findWaitAcceptUsingGETResponse>}
*/
export function findWaitAcceptUsingGET(params) {
  return API.get(`/undertake/app/wait-accept`, { params: { ...params.query })
}
