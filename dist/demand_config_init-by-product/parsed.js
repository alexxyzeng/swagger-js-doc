...
/**
 * @typedef {object} initByProductUsingPUTResponse
 ...
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/service-center-demand-config/initByProductUsingPUT
 * @summary 初始化需求配置-根据项目
 * @description 
 * @param {object} params
 
 * @return {Promise<initByProductUsingPUTResponse>}
*/
export function initByProductUsingPUT() {
  return API.put(`/demand/config/init-by-product`, {})
}
