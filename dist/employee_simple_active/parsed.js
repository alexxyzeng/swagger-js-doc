...
/**
 * @typedef {object} findSimpleOfActiveUsingGETResponse
...
/**
 * @tags base-employee
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/base-employee/findSimpleOfActiveUsingGET
 ...
 * @return {Promise<findSimpleOfActiveUsingGETResponse>}
*/
export function findSimpleOfActiveUsingGET(params) {
  return API.get(`/employee/simple/active`, { params: { ...params.query })
}
