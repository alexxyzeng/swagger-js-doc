...
/**
 * @typedef {object} updateDemandTypeUsingPUTResponse
 ...
 * @link http://df-fm.v27.svc.cluster.local/swagger-ui.html#!/service-center-demand/updateDemandTypeUsingPUT
 * @summary 修改需求-需求类型
 * @description 
 * @param {object} params
 * @param {number} params.id - path
 * @param {updateDemandTypeUsingPUTBody} params.body - 请求体 undefined
 * @return {Promise<updateDemandTypeUsingPUTResponse>}
*/
